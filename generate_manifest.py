...
_SOURCES = [
    ("hustle_stats_2025_26.csv", "LeagueHustleStatsPlayer", "2025-26"),
    ("hustle_stats_2024_25.csv", "LeagueHustleStatsPlayer", "2024-25"),
    ("shot_defense_overall_2025_26.csv", "LeagueDashPtDefend (Overall)", "2025-26"),
    ("shot_defense_3pt_2025_26.csv", "LeagueDashPtDefend (3 Pointers)", "2025-26"),
    ("shot_defense_2pt_2025_26.csv", "LeagueDashPtDefend (2 Pointers)", "2025-26"),
    ("shot_defense_rim_2025_26.csv", "LeagueDashPtDefend (Less Than 6Ft)", "2025-26"),
    ("drives_2025_26.csv", "LeagueDashPtStats (Drives)", "2025-26"),
    ("draft_class_2026.csv", "sports-reference.com/cbb (via pull_2026_draft_class.py)", "2025-26 college season"),
]
...
for suffix in _PLAYTYPE_FILES:
    _SOURCES.append((f"playtype_defense_{suffix}_2025_26.csv", "SynergyPlayTypes (Defensive)", "2025-26"))
    _SOURCES.append((f"playtype_offense_{suffix}_2025_26.csv", "SynergyPlayTypes (Offensive)", "2025-26"))
